...
build = {
   type = "builtin",
   modules = {
       ["opentelemetry.api.baggage"] = "lib/opentelemetry/api/baggage.lua",
       ["opentelemetry.api.context"] = "lib/opentelemetry/api/context.lua",
       ["opentelemetry.api.trace.event"] = "lib/opentelemetry/api/trace/event.lua",
       ["opentelemetry.api.trace.link"] = "lib/opentelemetry/api/trace/link.lua",
       ["opentelemetry.api.trace.id_generator"] = "lib/opentelemetry/api/trace/id_generator.lua",
       ["opentelemetry.api.trace.span_context"] = "lib/opentelemetry/api/trace/span_context.lua",
       ["opentelemetry.api.trace.span_kind"] = "lib/opentelemetry/api/trace/span_kind.lua",
       ...
       ["opentelemetry.api.utils.utils"] = "lib/opentelemetry/api/utils/utils.lua",
