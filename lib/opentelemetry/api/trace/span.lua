------------------------------------------------------------------------------------------------------------------------
-- Span represents a span in a trace. API spans are mostly no-ops.
--
...
--
-- @param[type=table] _attribute Table of @{api.trace.attribute} to set on the span.
--
-- @return @{api.trace.span}
------------------------------------------------------------------------------------------------------------------------
function _M:set_attribute(_attribute)
    return self
end
...
--
-- @param[type=table] _attributes Table of @{api.trace.attribute} to set on the span.
--
-- @return @{api.trace.span}
------------------------------------------------------------------------------------------------------------------------
...
-- @return @{api.trace.span}
------------------------------------------------------------------------------------------------------------------------
function _M:add_event(_name, _timestamp, _attributes)
    return self
end
...
------------------------------------------------------------------------------------------------------------------------
-- Signals that operation described by this span has ended. Noops in API spans.
--
...
-- @param[type=table,opt={}] _attributes Optional table of @{api.trace.attribute} to set on the event.
--
-- @return @{api.trace.span}
------------------------------------------------------------------------------------------------------------------------
